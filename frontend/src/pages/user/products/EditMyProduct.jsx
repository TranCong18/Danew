          ...
          <div className="space-y-2">
            {product.variants.map((variant, idx) => (
              <div key={idx} className="flex gap-2 mb-2 items-end flex-wrap">
                ...
                <div className="flex flex-col">
                  <label className="text-xs mb-1">Màu sắc</label>
                  <input
                    type="text"
                    name="color"
                    placeholder="Màu sắc"
                ...
                <div className="flex flex-col">
                  <label className="text-xs mb-1">Số lượng</label>
                  <input
                    type="number"
                    name="stock"
                ...
                <div className="flex flex-col">
                  <label className="text-xs mb-1">Giá</label>
                  <input
                    type="number"
                    name="price"
                    placeholder="Giá"
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            {selectedImages.map((img, idx) => (
              <img
                ...
                className="object-cover w-20 h-20 rounded border-2 border-blue-400"
              />
            ))}
          </div>
        </div>
